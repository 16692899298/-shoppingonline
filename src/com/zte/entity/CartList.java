...
public class CartList {
	...
	public CartList(int hp_id, String hp_name, String hp_description, double price, int hp_stock, int hpc_id,
	...
	public String toString() {
		return "CartList [hp_id=" + hp_id + ", hp_name=" + hp_name + ", hp_description=" + hp_description + ", price="
				+ price + ", hp_stock=" + hp_stock + ", hpc_id=" + hpc_id + ", hpc_child_id=" + hpc_child_id
				+ ", hp_file_name=" + hp_file_name + ", quantity=" + quantity + "]";
	}
