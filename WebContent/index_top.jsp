	...
	<div class="login_menu">
		<div class="login_container">
			...
			<ul class="m_right">
				...
				<li><img src="images/icon_2.png"><a href="AllComments">留言</a></li>
				<li><img src="images/icon_1.png"><a href="NewFile.jsp">首页</a></li>
			</ul>
		</div>
	</div>
		...
		<div class="nav_bar_container">
			<ul>
				...
				<c:if test="${sessionScope.hotProducts!=null }">
					<c:forEach items="${sessionScope.hotProducts }" var="p" end="2">
						<li>|</li>
				...
				<c:forEach items="${categoryInfo }" var="c" begin="3" end="5">
					<c:forEach items="${c[1] }" var="category" end="4">
						<li>|</li>
						<li><a href="wwww?cate=child&hpc_child_id=${category.hpc_id }">${category.hpc_name }</a></li>
					</c:forEach>
				</c:forEach>
			</ul>
		</div>
