			...
			<form id="regForm" method="post" action="registerServlet" onsubmit="return checkForm(this)">
				<table>
					...
					<tr>
						...
						<td><input class="text" type="text" name="identity" onfocus="FocusItem(this)" onblur="CheckItem(this);" id="identity" /><span id="uidentity"></span></td>
					</tr>
					<tr>
						<td class="field">出生日期：</td>
						<td><input class="text" type="text" name="birthday" onfocus="FocusItem(this)" onblur="CheckItem(this);" id="birthday" readonly="readonly" /><span></span></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input class="text" type="text" name="mobile" onfocus="FocusItem(this)" onblur="CheckItem(this);"  id="mobile" /><span id="umobile"></span></td>
					</tr>
					<tr>
...
<div id="footer">
	Copyright &copy; 2019 上海海文 All Rights Reserved. 京ICP证1000001号
</div>
</body>
</html>
