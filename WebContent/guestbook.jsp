	...
	<div class="main">
		<div class="guestbook">
			...
			<ul>
				...
				<li>
					<dl>
						<dt>标题：${comments.reply }</dt>
						<dd class="author"><span>作者：${comments.name }</span></dd>
						<dd>留言时间：${ comments.create_time }</dd>
						<dd>内容：${comments.content }</dd>
				...
				<form action="addComment" method="post" onsubmit="return commentCheck()">
					...
					<table>
						<tr>
							...
							<td><input class="text" type="text" name="guestName" maxlength="10" /></td>
						</tr>
						<tr>
							<td class="field">留言标题：</td>
							<td><input class="text" type="text" name="guestTitle"maxlength="10" /></td>
						</tr>
						<tr>
							<td class="field">留言内容：</td>
							<td><textarea name="guestContent" maxlength="200"></textarea></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
